...
class TelegramBot extends EventEmitter {
  ...
  // THESE GET OVERRIDEN
  processButtCoin(data) {
    if (this.buttcoin_processor !== undefined){
      this.buttcoin_processor(data);
    } else {
      console.log('u forgot to override me : (');
    }
  }

  processAliveCheck(res) {
    if (this.alive_check !== undefined){
      this.alive_check(function(r){
        res.end(r);
        return 'OK';
      });
    } else {
  ...
  register_wallet(c){
    ...
    var wallet_info = {
      url: c.HEROKU_URL,
      botuser: c.BOT_USERNAME,
      block_opts: c.blocktrail_opts,
      w_name: c.WALLET_NAME,
      w_pass: c.WALLET_PASS
    };

    var options = {
        method: 'POST',
        uri: 'http://blocktrail.herokuapp.com/register_wallet',
        body: wallet_info,
