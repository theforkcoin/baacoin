...
ADMIN_LIST: [545047563], // these users will have access to admin menu
// any user in the following two groups must also be in the above
APPROVAL_ADMIN_LIST: [545047563], // these admins will be notified whenever a user
// tries to make a withdrawal, only they can approve said withdrawal
DEV_ADMIN_LIST: [545047563], // these admins have access to some extra commands
